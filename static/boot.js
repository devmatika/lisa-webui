...
(async()=>{
  ...
  try{
    ...
    window._botName=s.bot_name||((typeof Branding!=='undefined'&&Branding.defaultBotName)?Branding.defaultBotName():'Matika AI Assistant');
    ...
    _applyComposerControlOrder(window._composerControlOrder);
    window._botName=((typeof Branding!=='undefined'&&Branding.defaultBotName)?Branding.defaultBotName():'Matika AI Assistant');
